...
class AIConfig {
    // Default to Gemini directly
    private $ai_provider = "gemini"; // Options: openai, claude, gemini, openrouter, custom
    ...
    private $model = "gemini-2.0-flash-exp"; // Gemini model
    ...
    public function __construct() {
        ...
        // Support multiple providers: Gemini, Claude, OpenAI
